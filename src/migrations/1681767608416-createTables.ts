...
export class createTables1681767608416 implements MigrationInterface {
    name = 'createTables1681767608416'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "professional_level" character varying NOT NULL, "kind_of_work" character varying NOT NULL, "is_admin" boolean NOT NULL DEFAULT false, "departmentId" integer, CONSTRAINT "REL_554d853741f2083faaa5794d2a" UNIQUE ("departmentId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
